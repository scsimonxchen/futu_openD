...
import com.futu.opend.data.collector.client.FutuApiException;
import com.futu.opend.data.collector.client.FutuQuoteClient;
import com.futu.opend.data.collector.client.FutuTradeClient;
import com.futu.opend.data.collector.config.AppConfig;
import com.futu.opend.data.collector.storage.DataStore;
import com.futu.opend.data.collector.util.TrdMarketParser;
    ...
    static int runTrade(GlobalOptions globals, String env, String market, TradeAction action) {
        ...
        try {
            ...
            try {
                ...
                TrdCommon.TrdEnv trdEnv = TrdMarketParser.parseEnv(env);
                TrdCommon.TrdMarket trdMarket = TrdMarketParser.parseMarket(market);
