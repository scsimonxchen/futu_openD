...
import com.stocklab.collector.service.QuoteApiType;
...
public class QuotePullCommand implements Runnable {
    ...
    @Option(names = {"--interval"}, defaultValue = "day", description = "K-line interval for get-kl")
    String interval;

    @Option(names = {"--rehab"}, defaultValue = "forward", description = "Rehab type for get-kl")
    String rehab;

    @Option(names = {"--num"}, defaultValue = "50", description = "Num bars/ticks for get-kl/get-rt/get-ticker")
    int num;
