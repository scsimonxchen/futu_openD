...
public interface FTSPI_Trd {
    ...
    default void onReply_GetComboMaxTrdQtys(FTAPI_Conn client, int nSerialNo, TrdGetComboMaxTrdQtys.Response rsp){} //获取组合的可买卖信息
    ...
    default void onReply_PlaceComboOrder(FTAPI_Conn client, int nSerialNo, TrdPlaceComboOrder.Response rsp){} //组合期权下单
    ...
    default void onReply_GetOrderFee(FTAPI_Conn client, int nSerialNo, TrdGetOrderFee.Response rsp){} //获取订单费用
    default void onReply_GetFlowSummary(FTAPI_Conn client, int nSerialNo, TrdFlowSummary.Response rsp){} //获取资金流水
